                                        ...
                                        <!-- Foto KTP -->
                                                ...
                                                <div class="col-md-6">
                                                    <fieldset class="well bg-light">
                                                       ...
                                                       <img src="../android/user/foto_depan_rumah/<?= htmlspecialchars($pengajuan['Foto_Depan_Rumah']) ?>" alt="Foto Depan Rumah" style="max-width: 100%; height: 100%; border: 1px solid #ccc; border-radius: 5px;">
