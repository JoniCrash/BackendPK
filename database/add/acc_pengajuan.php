...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($data_pengajuan) {
        ...
        $query_pelanggan = "
            ...
            VALUES 
            ('$nama_lengkap', '$nomor_ktp', '$alamat', '$provinsi', '$kota', '$email', '$nomor_hp_1', '$nomor_hp_2', '$id_paket', '$nama_paket', '$fotktp', '$fotodepnrumah')";
        ...
        if (mysqli_query($koneksi, $query_pelanggan)) {
            ...
            $source_dir_ktp = 'android/user/foto_ktp/';
            $source_dir_depanrumah = 'android/user/foto_depan_rumah/';
            ...
            if (rename($source_file_ktp, $target_file_ktp) && rename($source_file_depanrumah, $target_file_depanrumah)) {
                ...
                echo "<script>alert('Gagal memindahkan file foto!'); window.location.href='index.php?page=data-pengajuan';</script>";
            }
        } else {
