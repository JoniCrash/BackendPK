...
if (!in_array($Status, ['Menunggu', 'Di Tolak', 'Di setujui'])) {
...
if (mysqli_query($koneksi, $query)) {
    echo json_encode(["success" => true, "message" => "Status Request Paket berhasil diperbarui."]);
} else {
    echo json_encode(["success" => false, "message" => "Gagal memperbarui status Request Paket: " . mysqli_error($koneksi)]);
}
?>
